...
BOOST_STATIC_CONSTEXPR size_t DEFAULT_SLOT_PER_BUCKET = 4;

//! The default number of elements in an empty hash table
BOOST_STATIC_CONSTEXPR size_t DEFAULT_SIZE =
    (1ULL << 16) * DEFAULT_SLOT_PER_BUCKET;
...
BOOST_STATIC_CONSTEXPR size_t LOCK_ARRAY_GRANULARITY = 0;
...
BOOST_STATIC_CONSTEXPR double DEFAULT_MINIMUM_LOAD_FACTOR = 0.05;
...
BOOST_STATIC_CONSTEXPR size_t NO_MAXIMUM_HASHPOWER = 0;
